rule DLL_Banking_Trojan_Chavedoak_March2024 {
    meta:
        Description = "Detects the lightshot DLL which is the Chavedoak Banking Trojan which was used to target banks in Brazil"
        Author = "RustyNoob619"
